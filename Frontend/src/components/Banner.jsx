        ...
        <div className="w-full md:w-1/2 mt-12 md:mt-32">
          <div className="space-y-12 ">
            ...
            <p className="tracking-wide leading-7">
              Books open doors to new worlds, ignite imagination, and offer
              solace. Dive into captivating stories, learn from experts, and
              explore the boundless universe of knowledge
            </p>
