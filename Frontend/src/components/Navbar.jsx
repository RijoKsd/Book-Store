...
const Navbar = () => {
  ...
  return (
    <>
      <hr />
      <div
        className={` fixed z-10  inset-x-0 top-0   dark:bg-slate-900 dark:text-white max-w-screen-2xl container mx-auto md:px-20 px-4 ${
          sticky
            ? "bg-base-200  shadow-md duration-300 transition-all ease-in-out dark:bg-slate-800 dark:text-white"
            : ""
        } `}
      >
